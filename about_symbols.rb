...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols?
	#
	# A: To compare the contents. Symbols have the same object identities, and are thus not comparable.
  ...
  # Why is it not a good idea to dynamically create a lot of symbols?
	#
	# A: Symbols consume memory that cannot be freed until the program has finished running.
end
